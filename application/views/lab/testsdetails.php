      ...
      <div class="panel tab-border card-topline-green">
         <header class="panel-heading panel-heading-gray custom-tab ">
            <ul class="nav nav-tabs">
               ...
               <li class="nav-item"><a href="#about" class="<?php if(isset($tab) && $tab ==1){ echo "active"; } ?>" data-toggle="tab">Test List</a>
               </li>
            </ul>
         </header>
                     ...
                     <div class="col-md-12 ">
                        <div class="container">
                           <div class="control-group" id="fields">
                              <label class="control-label" for="field1"><strong>Add Lab Test</strong></label>
                              <div class="">
                                 <form action="<?php echo base_url('lab/addtest'); ?>" method="post" id="addform" name="addform">
                                      <div class="form-group col-md-6">
											  <label for="Name">Name</label>
											  <input type="text" class="form-control" id="name"  name="name" placeholder="Enter Test Name" value="">
											</div>
									   <div class="form-group col-md-6">
											  <label for="mobile">Short Form</label>
											  <input type="text" class="form-control" id="short_form"  name="short_form" placeholder="Enter Short Form" value="">
											</div>
											<div class="form-group col-md-6">
											...
											<div class="form-group col-md-6">
											  ...
											  <input type="text" class="form-control" id="department"  name="department" placeholder="Enter Department" value="">
											</div>
        ...
        fields: {
			...
			short_form: {
                validators: {
					...
					regexp: {
					regexp: /^[a-zA-Z0-9. ]+$/,
					message: 'Short Form can only consist of alphanumaric, space and dot'
					}
                }
            },
			description: {
