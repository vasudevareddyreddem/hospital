						...
						<div class="panel ">
												...
												<div class="panel-body" style="height:300px;overflow-y: scroll;">
													...
													<li class="left clearfix"><span class="chat-img pull-left">
															<span class="bg-indigo" style="padding:15px;border-radius:50%" ><b><?php echo ucfirst(substr($List['replayname'], 0, 2)); ?></b></span>
														</span>
															<div class="chat-body clearfix">
																<div class="header">
																	<strong class="primary-font"><?php echo isset($List['replayname'])?$List['replayname']:''; ?></strong> <small class="pull-right text-muted">
														...
														<li class="right clearfix"><span class="chat-img pull-right">
															...
															<div class="chat-body clearfix">
																<div class="header">
																	...
																	<strong class="pull-right primary-font"><?php echo isset($List['replayedname'])?$List['replayedname']:''; ?></strong>
																</div>
																<p><?php echo isset($List['comment'])?$List['comment']:''; ?>
																</p>
																<?php if(isset($List['image']) && $List['image']!=''){ ?>
																<p><a target="_blank" href="<?php echo base_url('assets/chating_file/'.$List['image']);?>">download</a>
																<?php } ?>
