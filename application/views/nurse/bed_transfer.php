                                                    ...
                                                    <table id="example4" class=" table table-bordered" style="width:100%;">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <?php echo $list['ward_name']; ?>
                                                                </td>
                                                                <td>
                                                                    <?php echo $list['ward_type']; ?>
                                                                </td>
                                                                <td>
                                                                    <?php echo $list['room_type']; ?>
                                                                </td>
                                                                <td>
                                                                    <?php echo $list['ward_floor']; ?>
                                                                </td>
                                                                <td>
                                                                    <?php echo $list['room_num']; ?>
                                                                </td>
                                                                <td>
                                                                    <?php echo $list['bed']; ?>
                                                                </td>
                                                                <td>
                                                                    <?php echo $list['date_of_admit']; ?>
                                                                </td>
                                                                <td>
                                ...
                                <div id="step-3" class="">
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="panel-body">
                                                <div class="table-responsive">
                                                    <?php if(isset($tranfor_bed_patient_list) && count($tranfor_bed_patient_list)>0){ ?>
                                                    <table id="example5" class="table table-bordered" style="width:100%;">
                                                        ...
                                                        <tbody>
                                                            <?php foreach($tranfor_bed_patient_list as $list){ ?>
                                                            <tr>
                                                                <td>
                                                                    <?php echo $list['pt_id']; ?>
                                                                </td>
                                                                ...
                                                                <td>
                                                                    <?php if($list['status']==1){ echo "Success";}else if($list['status']==2){ echo "Rejected"; }else{ echo "Pending"; } ?>
                                                                </td>
                                                            </tr>
                                                            <?php } ?>
                                                        </tbody>
                                                ...
                                                <div class="row d-flex justify-content-center">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select class="form-control" name="ward_name" id="ward_name">
                                                            ...
                                                            <option selected value="<?php echo $List['w_id'];?>">
                                                                <?php echo $List['ward_name'];?>
                                                            </option>
                                                            <?php }else{ ?>
                                                            <option value="<?php echo $List['w_id'];?>">
                                                                <?php echo $List['ward_name'];?>
                                                            </option>
                                                            <?php } ?>
                                                            <?php } ?>
                                                ...
                                                <div class="row d-flex justify-content-center">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select class="form-control" name="ward_type" id="ward_type">
                                                            ...
                                                            <option selected value="<?php echo $List['ward_id'];?>">
                                                                <?php echo $List['ward_type'];?>
                                                            </option>
                                                            <?php }else{ ?>
                                                            <option value="<?php echo $List['ward_id'];?>">
                                                                <?php echo $List['ward_type'];?>
                                                            </option>
                                                            <?php } ?>
                                                            <?php } ?>
                                                ...
                                                <div class="row d-flex justify-content-center">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select class="form-control" name="room_type" id="room_type">
                                                            ...
                                                            <option selected value="<?php echo $List['w_r_t_id'];?>">
                                                                <?php echo $List['room_type'];?>
                                                            </option>
                                                            <?php }else{ ?>
                                                            <option value="<?php echo $List['w_r_t_id'];?>">
                                                                <?php echo $List['room_type'];?>
                                                            </option>
                                                            <?php } ?>
                                                            <?php } ?>
                                                ...
                                                <div class="row d-flex justify-content-center">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select class="form-control" onchange="get_floorno_list(this.value);" name="floor_number" id="floor_number">
                                                            ...
                                                            <option selected value="<?php echo $List['w_f_id'];?>">
                                                                <?php echo $List['ward_floor'];?>
                                                            </option>
                                                            <?php }else{ ?>
                                                            <option value="<?php echo $List['w_f_id'];?>">
                                                                <?php echo $List['ward_floor'];?>
                                                            </option>
                                                            <?php } ?>
                                                            <?php } ?>
                                                ...
                                                <div class="row d-flex justify-content-center">
                                                    <div class="form-group col-md-6">
                                                        ...
                                                        <select class="form-control" id="roomno_id" onchange="get_bed_count(this.value);" name="room_num">
                                                            ...
                                                            <option selected value="<?php echo $List['w_r_n_id'];?>">
                                                                <?php echo $List['room_num'];?>
                                                            </option>
                                                            <?php }else{ ?>
                                                            <option value="<?php echo $List['w_r_n_id'];?>">
                                                                <?php echo $List['room_num'];?>
                                                            </option>
                                                            <?php } ?>
                                                            <?php } ?>
                                                                                    ...
                                                                                    <div class="panel-body">
                                                                                        <ol class="seats" type="A">
                                                                                            <li class="seat">
                                                                                                ...
                                                                                                <label for="1A<?php echo $List['r_b_id'] ?>">bed
                                                                                                    <?php echo $List['bed'];?></label>
                                                                                                <?php }else{ ?>
