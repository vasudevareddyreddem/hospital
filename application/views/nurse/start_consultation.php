...
<div id="smartwizard" class="col-md-12">
   ...
   <div>
      ...
      <div id="step-2" class="">
         ...
         <form id="add_medicines" name="add_medicines" onsubmit="return check_qty()"  action="<?php echo base_url('nurse/medicine'); ?>" method="post" >
...
function investdation_serach_one(val){
	if(val!=''){
   			$('#internal_code').empty();
   			jQuery.ajax({
   					url: "<?php echo base_url('resources/inside_investigationsearch');?>",
   					data: {
   						searchdata: val,
   					},
   					dataType: 'json',
