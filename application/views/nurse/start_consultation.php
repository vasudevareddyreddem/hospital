                    ...
                    <div class="row py-4 px-2">
                        <div class="col-md-9 table-responsive">
                            <table class="" border="1" border-color="red" cellpadding="15px" style="border-collapse: collapse;width: 100%;border-color: #ccc; border: 1px solid #ccc;">
                                ...
                                <tr>
                                    <td>
                                        <?php echo isset($patient_details['name'])?$patient_details['name']:''; ?>
                                    </td>
                                    <td>
                                        <?php echo isset($patient_details['gender'])?$patient_details['gender']:''; ?>
                                    </td>
                                    <td>
                                        <?php echo isset($patient_details['mobile'])?$patient_details['mobile']:''; ?>
                                    </td>
                                    <td>
                                        <?php echo isset($patient_details['bloodgroup'])?$patient_details['bloodgroup']:''; ?>
                                    </td>
                                    <td>
                                        <?php echo isset($patient_details['age'])?$patient_details['age']:''; ?>
                                    </td>
                                    <td>
                                                ...
                                                <table id="example1" class="table table-striped table-bordered">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php echo isset($list['bp'])?$list['bp']:''; ?>
                                                            </td>
                                                            <td>
                                                                <?php echo isset($list['pulse'])?$list['pulse']:''; ?>
                                                            </td>
                                                            <td>
                                                                <?php echo isset($list['fbs_rbs'])?$list['fbs_rbs']:''; ?>
                                                            </td>
                                                            <td>
                                                                <?php echo isset($list['temp'])?$list['temp']:''; ?>
                                                            </td>
                                                            <td>
                                                                <?php echo isset($list['weight'])?$list['weight']:''; ?>
                                                            </td>
                                                        ...
                                                        <div class="col-sm-3 nopadding">
                                                            ...
                                                            <div class="form-group">
                                                                <select class="form-control  select2" id="medicine_name0" name="medicine_name[]">
                                                                    ...
                                                                    <option value="<?php echo $list['medicine_name'].'_'.$list['qty']; ?>">
                                                                        <?php echo $list['medicine_name']; ?>-
                                                                        <?php echo "dosage ".$list['dosage']; ?> -
                                                                        <?php echo "Avl qty :".$list['qty']; ?> -
                                                                        <?php echo "Type :".$list['medicine_type']; ?>
                                                                    </option>
                                                                    <?php } ?>
                                                                </select>
                                                            </div>
                                                        ...
                                                        <div class="row">
                                                            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="example4">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr class="odd gradeX">
                                                                        <td>
                                                                            <?php echo isset($list['medicine_name'])?$list['medicine_name']." - dosage ".$list['dosage']." - type ".$list['medicine_type']:''; ?>
                                                                        </td>
                                                                        <td>
                                                                            <?php echo $list['batchno']; ?>
                                                                        </td>
                                                                        <td>
                                ...
                                $("#smartwizard").on("leaveStep", function(e, anchorObject, stepNumber, stepDirection) {
                                    if (stepNumber == 1 && stepDirection == 'forward') {
                                        ...
                                        if ($('#frequency').val() == '' && $('#priority').val() == '') {
                                            alert('Medication/Investigation details required');
                                            return false;
                                        }
                                        <?php } ?>
