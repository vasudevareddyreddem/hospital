...
<head>
    ...
    <link href="assets/vendor/css/compiled.min.css" rel="stylesheet">
    <!-- Your custom styles (optional) -->
    <link href="assets/vendor/css/custom.css" rel="stylesheet">
	<script type="text/javascript" src="assets/vendor/js/jquery-3.2.1.min.js"></script>
...
<div id="carousel-example-1z" class="carousel slide carousel-fade" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item active">
            <img class="d-block w-100" src="img/mainsite/b2.jpg" alt="First slide">
        </div>
        <!--/First slide-->
        <!--Second slide-->
        <div class="carousel-item">
            <img class="d-block w-100" src="img/mainsite/b3.jpg" alt="Second slide">
        </div>
        <!--/Second slide-->
        <!--Third slide-->
        <div class="carousel-item">
            <img class="d-block w-100" src="img/mainsite/b1.jpg" alt="Third slide">
        </div>
        <!--/Third slide-->
    </div>
    <!--/.Slides-->
...
<!--/.Carousel Wrapper-->
 ...
 <div class="container-main card">
    ...
    <div class="col-lg-5 mb-r center-on-small-only">
        <img src="img/mainsite/aboutus.png" alt="" class="img-fluid z-depth-0">
    </div>
    <!--Grid column-->
...
<!--Section: Features v.3-->
 ...
 <section class="" >
    ...
    <div class="col-md-4 mb-2 center-on-small-only flex-center">
        <img class="img-fluid" src="img/mainsite/features.png" alt="" class="z-depth-0">
    </div>
    <!--Grid column-->
...
<div class="container-main card" id="faq" >
 <section class="" >
	...
	<div class="col-lg-4 center-on-small-only card" style="margin-left:40px;">
        <img src="img/mainsite/faq.png" alt="" class="img-fluid z-depth-0">
    </div>
    <!--Grid column-->
...
<!--/footer end -->
   ...
   <script type="text/javascript" src="assets/vendor/js/bootstrap.min.js"></script>
    ...
    <script type="text/javascript" src="assets/vendor/js/compiled.min.js"></script>
